...
Thanks for purchasing the Shakeit Flyer Template.
...
I **HIGHLY** suggest to familiarise yourself with what folders do what, is to quickly go down the layer
...
The free font used in the design is:

Compacta D : which can be downloaded here - http://www.fonts101.com/fonts/view/Uncategorized/44945/Compacta_D.aspx

"Times New Romant" is also used in the design.

The image used in the preview on Graphic River can be fount at www.officialpsds.com
...
Placing your image in the design is very simple.

1: Locate the folder called "YOUR IMAGE HERE***" (Highlighted in Purple)
...
I have included a secondary photo layer if you want to use two images in the design.
...
There are 3 other adjustment layers above the photo layers. Use these to tweak the look
...
On the folder "YOUR IMAGE HERE***" is a layer mask (Black and white image). The white in 
the mask is the area that your image will be shown, the black areas hide the image.... you 
can simply brush more white or black into this mask. To hide the mask you can hold down
SHIFT and click on the mask and a red "X" will appear, or you can right click on the mask
and delete it.
...
The sticker text is outside of the main text folder and can be found in the "Sticker With Text"
folder.
...
4: Some folders inside the the folder "BACKGROUND DESIGN" have layers setup called "Change Color".
This is just a quick way to re-color what is inside the folder.

5: The very bottom layer "Background Color" affects the colors of the design quite alot.

6: I have setup an experimental color layer called "Color Mixer" for you to checkout.
