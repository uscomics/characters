...
Thanks for purchasing the Light Runnger Photoshop action.
...
Make sure that your photo is in RGB mode and your photo layer is called "Background"

It is highly recommended to work with photos over 1500px high or wide for the best results.

************************************************************

IMPORTANT! Please watch the below video tutorial on how to load the action and how to adjust
the look of your design after the action has stopped. 


https://www.youtube.com/watch?v=U8pAaJWBCGM&feature=youtu.be
...
'Low Poly' folder by selecting the triangle icon.

3. Next with the 'Light Runner Action' selected, hit the 'Play' icon at the bottom of the 
actions window.
...
If you need to color grade your photos, I highly recommend 'Photo Master' via the link below.
