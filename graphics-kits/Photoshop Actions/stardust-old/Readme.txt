...
Thanks for purchasing the StarDust Photoshop action.
...
http://www.youtube.com/watch?v=vzvcdCcQvyo
...
lower you go under 1000px high/wide. Photos with good color variation and contrast wil
work best.
...
5. Now choose a direction you want the effect to shoot off into and
hit the play button found at the bottom of the action panel.
...
Remember to experiment with all the different layers after the action has finished.
Duplicate, rotate, change blend mode etc. You can make incredible detailed designs
will only a few minutes of experimenting with the layers.
